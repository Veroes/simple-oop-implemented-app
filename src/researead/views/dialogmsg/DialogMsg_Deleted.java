 ...
 * @author rifpc
 */
public class DialogMsg_Deleted extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DeleteBook
     */
    public DialogMsg_Deleted(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Book successfully deleted!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogMsg_Deleted.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogMsg_Deleted dialog = new DialogMsg_Deleted(new javax.swing.JFrame(), true);
