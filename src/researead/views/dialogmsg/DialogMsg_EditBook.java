 ...
 * @author rifpc
 */
public class DialogMsg_EditBook extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DeleteBook
     */
    public DialogMsg_EditBook(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogMsg_EditBook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogMsg_EditBook dialog = new DialogMsg_EditBook(new javax.swing.JFrame(), true);
